...
const rules1 = [{
  ...
  name: true,
  telError: "Enter correct name",
  rules: [{
    rule: "minLength",
    value: 3,
    errorMessage: "min 3 symbols!"
  }, {
    rule: "maxLength",
    value: 30,
    errorMessage: "not more 30 symbols!"
  }, {
    rule: "required",
    value: true,
  ...
  tel: true,
  telError: "Enter correct tel",
  rules: [{
    rule: "required",
    value: true,
    errorMessage: "Error, tel not enter."
  }]
}];
const rules2 = [{
  ruleSelector: ".input-name",
  ...
  rules: [{
    rule: "minLength",
    value: 3,
    errorMessage: "More 3 symbols!"
  }, {
    rule: "maxLength",
    value: 30,
    errorMessage: "15 symbols max!"
  }, {
    rule: "required",
    value: true,
  ...
  rules: [{
    ...
    rule: "required",
    value: true,
    errorMessage: "Error, input email ."
  }]
}];
const afterForm = () => {
  console.log('Произошла отправка, тут можно писать любые действия');
};
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_1__.validateForms)(".form", rules1, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_1__.validateForms)(".form-main", rules2, afterForm);
...
const mySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".main-slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  loop: true,
  lazy: true,
...
const gallery = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slider-gallery", {
